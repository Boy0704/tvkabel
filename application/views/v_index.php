...
<head>
  ...
  <title>Administrator | PT. NMV NIPAH PANJANG</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-lg">PT. NMV</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; Boy Kurniawan, S.Kom <?php echo date('Y') ?>.</strong> All rights
    reserved.
  </footer>
