		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('wilayah/update/'.$wilayah->id_wilayah),'<span class="label label-info">Ubah</span>'); 
				echo ' | '; 
				echo anchor(site_url('wilayah/delete/'.$wilayah->id_wilayah),'<span class="label label-danger">Hapus</span>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
